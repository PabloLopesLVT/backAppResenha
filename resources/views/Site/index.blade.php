    ...
    <div class="container h-100">
      <div class="row align-items-center h-100">
        <div class="col-lg-6 wow fadeInUp">
          <div class="badge mb-2"><span class="icon mr-1"><span class="mai-globe"></span></span> #Simplificando as Resenhas!</div>
          <h1 class="mb-4">App Resenha</h1>
          <p class="mb-4">Venda mais com o App Resenha!</p>
          <a href="#" class="btn btn-primary rounded-pill">Quero vender pelo com o Resenha</a>
        </div>
        ...
        <div class="iconic-list">
          <div class="iconic-item wow fadeInUp">
            ...
            <div class="iconic-content">
              <h5>Venda para clientes próximos!</h5>
